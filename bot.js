...
setInterval(() => {
  http.get(`http://al-pasha-system.glitch.me/`);
}, 280000);
...
client.on('message', msg => {  
  ...
  client.on("message", message => {  
    if(message.content.startsWith(prefix + 'مؤقت')) {  
...
\`${prefix}gRole Role name ====> يوريك معلومات رتبة باسمها او الايدي حقها
...
client.login('NjY4NTYwMTY1NjAzMTE1MDE4.XiTDWQ.r4ftlsHO_IHnzNJVbcNxE0Kojz4');
